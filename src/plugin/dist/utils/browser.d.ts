 ...
 */
type ExecFileFn = (command: string, args: string[], callback: ExecCallback) => unknown;
/**
 ...
 */
declare function openURLWithExec(url: string, execFn?: ExecFileFn): Promise<void>;
/**
 * 在默认浏览器中打开 URL
 *
 * 平台映射：
...
export { type ExecFileFn, openURL, openURLWithExec };
