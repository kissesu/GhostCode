...
export type CheckStatus = "Pending" | "Passed" | { Failed: string };

/** 运行整体状态（与 Rust RunStatus 枚举对齐） */
export type RunStatus = "Running" | "Approved" | "Rejected" | "Cancelled";
...
/** 验证判定结果（语义化，用于外部消费） */
export type Verdict = "approved" | "rejected" | "cancelled" | "in_progress";
